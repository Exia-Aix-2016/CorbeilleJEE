...
import com.goodcesi.qualifier.Authentificated;
...
public class SellerItemListBean implements Serializable{
  //On utilise une map contenant les listes à vendre et vendus  
    ...
    @Inject
    public SellerItemListBean(CatalogManagerLocal catalogManager, @Authentificated CurrentUser user) {//les arguments sont des points d'injection
